...
#SBATCH -e ./mrDiff_runs/%A/err_job_%a.txt       # stderr file with job ID (%A) and task ID (%a)
...
conda activate ecg                             # Activate the conda environment

# Create output directory with the job ID if it doesn't exist
mkdir -p ./mrDiff_runs/${SLURM_ARRAY_JOB_ID}

# Define the base command
BASE_CMD="/home/liranc6/miniconda3/envs/ecg_new/bin/python ./liran_project/mrdiff/main_default.py"
